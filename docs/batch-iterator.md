...
<DaytonaRunner pattern="batch-iterator" />
...
- [Continue-as-New pattern](continue-as-new) — core concepts for history management via `continueAsNew`
- [Sliding Window](sliding-window) — bounded concurrency that progresses at the rate of the fastest processor
- [MapReduce Tree](mapreduce-tree) — fully parallel processing for maximum speed
