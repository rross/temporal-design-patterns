...
<DaytonaRunner pattern="eager-workflow-start" />
...
:::info TypeScript SDK
The TypeScript SDK does not currently support Eager Workflow Start. Use [Local Activities](/local-activities) or [Early Return + Local Activities](/early-return-local-activities) for latency-sensitive TypeScript workflows.
:::
...
- First-response latency matters more than total latency—combine with [Early Return](/early-return) or [Early Return + Local Activities](/early-return-local-activities) for that use case
...
- [Local Activities](/local-activities) — eliminates per-Activity server round-trips; pairs naturally with Eager Workflow Start
- [Early Return + Local Activities](/early-return-local-activities) — minimum first-response latency via Update-with-Start plus Local Activities
- [Early Return](/early-return) — returns early to the client via Update-with-Start
