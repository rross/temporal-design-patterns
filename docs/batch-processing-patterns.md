<h1>Batch Processing Patterns <img src="/images/fanout-child-workflows-icon.svg" alt="Batch Processing Patterns" class="pattern-page-icon"></h1>
...
- [Task Orchestration Patterns](/task-orchestration-patterns) — the child-Workflow and parallel primitives these patterns scale up
- [QoS & Throughput Patterns](/qos-throughput-patterns) — rate-limit and prioritize the work a batch generates
- [Performance & Latency Patterns](/performance-latency-patterns) — reduce the latency of each record's processing
